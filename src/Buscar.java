...
public class Buscar extends JFrame {
	...
	public Buscar() {
		...
		textfID.setBounds(185, 30, 42, 20);
		contentPane.add(textfID);
		textfID.setColumns(10);
		
		JLabel lblNewLabel = new JLabel("Buscar por Id del evento");
		lblNewLabel.setFont(new Font("Tahoma", Font.PLAIN, 14));
		lblNewLabel.setBounds(20, 30, 155, 20);
		...
		btnBuscar.setBounds(135, 276, 120, 41);
